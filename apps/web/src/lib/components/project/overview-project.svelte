...
<div class="border-border -m-2 border-b-2 p-2">
	<div class="my-3 grid h-full grid-rows-4 items-end gap-6 px-3 md:mx-auto md:max-w-5xl md:px-0">
...
<div class="mt-7 md:mx-auto md:max-w-5xl">
